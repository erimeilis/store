...
import { transformGroupedMultiselectData, isGroupedMultiselectValue, parseGroupedMultiselect } from '@/utils/multiselectTransform.js'
    ...
    for (const row of tableData.data) {
      ...
      if (price > 0 && qty > 0) {
        publicItems.push({
          ...
          qty,
          available: qty > 0,
          data: transformGroupedMultiselectData(parsedData),
