...
// .wrangler/tmp/bundle-LfUGQ7/checked-fetch.js
...
var app = new Hono2();
app.use("*", cors({
  origin: ["http://localhost:5173", "http://localhost:8787", "https://*.workers.dev", "https://*.pages.dev", "https://store-crud-front.pages.dev", /https:\/\/[a-zA-Z0-9-]+\.store-crud-front\.pages\.dev/],
...
var createBearerAuthMiddleware = /* @__PURE__ */ __name((requiredPermission) => {
  return async (c, next) => {
    ...
    let userContext = { id: "anonymous", permissions: [] };
...
// .wrangler/tmp/bundle-LfUGQ7/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-LfUGQ7/middleware-loader.entry.ts
