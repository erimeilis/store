...
// .wrangler/tmp/bundle-na72cF/checked-fetch.js
...
var authMiddleware = /* @__PURE__ */ __name(async (c, next) => {
  try {
    ...
    if (!token) {
      const sessionToken = getCookie(c, "next-auth.session-token") || getCookie(c, "__Secure-next-auth.session-token");
      if (!sessionToken) {
        return c.json({
...
// .wrangler/tmp/bundle-na72cF/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-na72cF/middleware-loader.entry.ts
