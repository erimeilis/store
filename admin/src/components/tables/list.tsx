...
import { IconColumns3, IconCopy, IconDatabase, IconClockDollar, IconShoppingCart } from '@tabler/icons-react'
import { TableCloneModal } from '@/components/tables/clone-modal'
import { AdminTools } from '@/components/tables/admin-tools'
...
export function TableList({
  ...
  return (
    <>
      ...
      {isAdmin && user?.id && <AdminTools userId={user.id} />}
