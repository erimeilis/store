  ...
  if (status === "loading") {
    return (
      <div className="flex items-center space-x-4">
        <div className="animate-pulse bg-blue-400 rounded px-3 py-1 w-20 h-8"></div>
      </div>
    )
  }
  ...
  return (
    <div className="flex items-center space-x-4">
      <button
        ...
        className="bg-white text-blue-600 hover:bg-blue-50 px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center space-x-2"
      >
