...
/**
 * StatFigure component for displaying stat icons/figures.
 */
...
function StatFigure({
    ...
    return (
        <Comp
            className={cn('stat-figure text-secondary', className)}
            {...props}
        />
    )
}
...
/**
 * StatTitle component for stat titles/labels.
 */
export interface StatTitleProps
    extends Omit<React.HTMLAttributes<HTMLDivElement>, 'color'>,
        VariantProps<typeof statTitleVariants> {
    /**
     * Whether to use as a child component (renders as Slot)
     */
    asChild?: boolean
...
function StatTitle({
    ...
    return (
        <Comp
            className={cn(statTitleVariants({ color }), className)}
            {...props}
        />
    )
}
...
/**
 * StatValue component for displaying stat values.
 */
...
function StatValue({
    ...
    return (
        <Comp
            className={cn(statValueVariants({ size, color }), className)}
            {...props}
        />
    )
}
...
/**
 * StatDesc component for stat descriptions.
 */
export interface StatDescProps
    extends Omit<React.HTMLAttributes<HTMLDivElement>, 'color'>,
        VariantProps<typeof statDescVariants> {
    /**
     * Whether to use as a child component (renders as Slot)
     */
    asChild?: boolean
...
function StatDesc({
    ...
    return (
        <Comp
            className={cn(statDescVariants({ color }), className)}
            {...props}
        />
    )
}
...
const StatWithCompoundComponents = Stat as typeof Stat & {
  Figure: typeof StatFigure
  Title: typeof StatTitle
  Value: typeof StatValue
  Desc: typeof StatDesc
}

StatWithCompoundComponents.Figure = StatFigure
StatWithCompoundComponents.Title = StatTitle
StatWithCompoundComponents.Value = StatValue
StatWithCompoundComponents.Desc = StatDesc

export {
    Stats,
    StatWithCompoundComponents as Stat,
    StatFigure,
    StatTitle,
    StatValue,
    StatDesc,
