...
/**
 * HeroContent component for hero section content container.
 */
...
const HeroWithCompoundComponents = Hero as typeof Hero & {
...
HeroWithCompoundComponents.Content = HeroContent
HeroWithCompoundComponents.Title = HeroTitle
HeroWithCompoundComponents.Subtitle = HeroSubtitle
HeroWithCompoundComponents.Actions = HeroActions

export {
    HeroWithCompoundComponents as Hero,
    HeroContent,
    HeroTitle,
    HeroSubtitle,
    HeroActions,
