/**
 * Demo Page Component
 * Demo items table moved from dashboard
 */
...
export default function DemoPage({
  ...
  return (
    <ModelList<Item>
      ...
      filters={filters || {}}
      columns={itemColumns}
      createRoute="/demo/items/create"
      editRoute={(id) => `/demo/items/edit/${id}`}
...
export const metadata = {
  title: 'Demo Items',
  description: 'Demo items table for testing and showcase'
}