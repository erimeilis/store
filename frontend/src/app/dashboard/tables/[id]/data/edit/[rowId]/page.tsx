    ...
    <div className="container mx-auto p-4 max-w-2xl">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 text-sm breadcrumbs mb-2">
          <a href="/dashboard/tables" className="text-primary hover:text-primary-focus">
            Dynamic Tables
          </a>
          <span>/</span>
          <a 
          ...
          <span>/</span>
          <span className="text-gray-600">Edit Row</span>
        </div>
            ...
            {tableSchema.columns.map((column) => (
              <div key={column.id}>
                <label className="label">
                  ...
                  <span className="label-text-alt text-gray-500 capitalize">
                    {column.type}
                  </span>
                </label>
