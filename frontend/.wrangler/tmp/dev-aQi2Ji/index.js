...
// .wrangler/tmp/bundle-4WuBIl/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-4WuBIl/middleware-insertion-facade.js
init_modules_watch_stub();
...
app.use(
  reactRenderer(({ children, initialProps }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("html", { "data-theme": "dim", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("head", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("link", { rel: "icon", href: faviconDataUri, type: "image/svg+xml" }),
        cssFiles.map((cssFile) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("link", { rel: "stylesheet", href: `/${cssFile}` }, cssFile)),
        !isProduction && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("link", { rel: "stylesheet", href: "/styles.css" }),
        initialProps && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("script", { dangerouslySetInnerHTML: {
          __html: `window.__INITIAL_PROPS__ = ${JSON.stringify(initialProps)};`
        } })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("body", { className: "min-h-screen bg-base-200", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { id: "app", children }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("script", { type: "module", src: jsFile })
      ] })
    ] });
  })
);
...
app.get("/", (c6) => {
  ...
  return c6.render(/* @__PURE__ */ (0, import_jsx_runtime9.jsx)(LoginPage, { ...loginProps }), { initialProps: loginProps });
});
app.get("/dashboard", (c6) => {
  ...
  return c6.render(/* @__PURE__ */ (0, import_jsx_runtime9.jsx)(DashboardPage, { ...dashboardProps }), { initialProps: dashboardProps });
});
var auth = new Hono2();
auth.get("/token", (c6) => {
  return c6.json({
