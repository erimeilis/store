...
// .wrangler/tmp/bundle-iKUaxG/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-iKUaxG/middleware-insertion-facade.js
init_modules_watch_stub();
...
async function setupFirstUser(db, email, _name) {
  try {
    const batch = [
