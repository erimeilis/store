...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`, ct, er, tr, er), wr[er + ct] = true;
    ...
    __name(en, "en");
    var pn = en, hn = gt;
    Vi.Fragment = d, Vi.jsx = pn, Vi.jsxs = hn;
  }()), Vi;
}
__name(Gc, "Gc");
var Su;
...
var Ka = /* @__PURE__ */ __name((o, i, ...c) => (c.length && (i = Ka(i, ...c)), `${o?.[0] === "/" ? "" : "/"}${o}${i === "/" ? "" : `${o?.at(-1) === "/" ? "" : "/"}${i?.[0] === "/" ? i.slice(1) : i}`}`), "Ka");
...
var Qu = class {
  ...
  basePath(i) {
    const c = this.#e();
    return c._basePath = Ka(this._basePath, i), c;
  }
  ...
  mount(i, c, d) {
    ...
    l ||= (() => {
      const g = Ka(this._basePath, i), x = g === "/" ? 0 : g.length;
      return (M) => {
    ...
    return this.#a(Zt, Ka(i, "*"), P), this;
  }
  #a(i, c, d) {
    i = i.toUpperCase(), c = Ka(this._basePath, c);
  ...
  request = /* @__PURE__ */ __name((i, c, d, l) => i instanceof Request ? this.fetch(c ? new Request(i, c) : i, d, l) : (i = i.toString(), this.fetch(
    new Request(
      /^https?:\/\//.test(i) ? i : `http://localhost${Ka("/", i)}`,
      c
    ),
    d,
    l
...
var gf = new Set(".\\+*[^]$()");
function yf(o, i) {
  return o.length === 1 ? i.length === 1 ? o < i ? -1 : 1 : -1 : i.length === 1 || o === Ji || o === Zi ? 1 : i === Ji || i === Zi ? -1 : o === Gs ? 1 : i === Gs ? -1 : o.length === i.length ? o < i ? -1 : 1 : i.length - o.length;
}
__name(yf, "yf");
var nu = class {
  static {
  ...
  insert(i, c, d, l, S) {
    ...
    const [E, ...P] = i, g = E === "*" ? P.length === 0 ? ["", "", Ji] : ["", "", Gs] : E === "/*" ? ["", "", Zi] : E.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);
    let x;
    if (g) {
      const M = g[1];
      let I = g[2] || Gs;
  ...
  add(o, i, c) {
    ...
    if (/\*$/.test(i)) {
      ...
      o === Zt ? Object.keys(d).forEach((g) => {
        d[g][i] ||= Za(d[g], i) || Za(d[Zt], i) || [];
      }) : d[o][i] ||= Za(d[o], i) || Za(d[Zt], i) || [], Object.keys(d).forEach((g) => {
...
var tc = class {
  ...
  #n(o, i, c, d) {
    ...
    for (let S = 0, E = o.#t.length; S < E; S++) {
      ...
      if (g !== void 0 && (g.params = /* @__PURE__ */ Object.create(null), l.push(g), c !== Yi || d && d !== Yi))
...
function _f() {
  return _u || (_u = 1, function() {
    var o = oa(), i = "18.3.1", c = o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function d(e) {
      {
...
` && e.push(Jr), f;
    ...
    function Ro(e, t, r, a) {
      switch (r.insertionMode) {
        ...
        case Ve:
          return g(e, sa), g(e, t.segmentPrefix), g(e, a.toString(16)), x(e, to);
        case Qe:
          return g(e, la), g(e, t.segmentPrefix), g(e, a.toString(16)), x(e, ua);
        default:
    ...
    __name(pr, "pr");
    var Or = y + ';$RX("', Fr = '$RX("', no = '"', da = ")<\/script>", jn = ",";
    function el(e, t, r, a, f, v) {
      if (g(e, t.startInlineScript), t.sentClientRenderFunction ? g(e, Fr) : (t.sentClientRenderFunction = true, g(e, Or)), r === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return g(e, r), g(e, no), (a || f || v) && (g(e, jn), g(e, ii(a || ""))), (f || v) && (g(e, jn), g(e, ii(f || ""))), v && (g(e, jn), g(e, ii(v))), x(e, da);
    }
    __name(el, "el");
    var tl = /[<\u2028\u2029]/g;
    function ii(e) {
    ...
    __name(sl, "sl");
    var Rr = Object.assign, ll = Symbol.for("react.element"), es = Symbol.for("react.portal"), pa = Symbol.for("react.fragment"), Dr = Symbol.for("react.strict_mode"), ts = Symbol.for("react.profiler"), ha = Symbol.for("react.provider"), va = Symbol.for("react.context"), ma = Symbol.for("react.forward_ref"), ga = Symbol.for("react.suspense"), To = Symbol.for("react.suspense_list"), _o = Symbol.for("react.memo"), oo = Symbol.for("react.lazy"), si = Symbol.for("react.scope"), li = Symbol.for("react.debug_trace_mode"), ui = Symbol.for("react.legacy_hidden"), ya = Symbol.for("react.default_value"), rs = Symbol.iterator, ul = "@@iterator";
    function cl(e) {
    ...
    function kt(e) {
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          case va:
            var t = e;
            return ci(t) + ".Consumer";
          case ha:
            var r = e;
            return ci(r._context) + ".Provider";
          case ma:
    ...
    __name(kt, "kt");
    var Po = 0, ns, fi, wt, ao, di, pi, hi;
    function vi() {
    }
    __name(vi, "vi");
    vi.__reactDisabledLog = true;
    function os() {
      {
        if (Po === 0) {
          ns = console.log, fi = console.info, wt = console.warn, ao = console.error, di = console.group, pi = console.groupCollapsed, hi = console.groupEnd;
          var e = {
            configurable: true,
            enumerable: true,
            value: vi,
    ...
    __name(as, "as");
    var ba = c.ReactCurrentDispatcher, wa;
    function Io(e, t, r) {
      {
        if (wa === void 0)
          try {
...
` + wa + e;
    ...
    function Ln(e, t) {
      ...
      Error.prepareStackTrace = void 0;
      var v;
      v = ba.current, ba.current = null, os();
      try {
        if (t) {
...
` + R[Y].replace(" at new ", " at ");
        ...
        mi = false, ba.current = v, as(), Error.prepareStackTrace = f;
      }
    ...
    __name(Oo, "Oo");
    var is = {}, bi = c.ReactDebugCurrentFrame;
    function Sa(e) {
      if (e) {
        var t = e._owner, r = Oo(e.type, e._source, t ? t.type : null);
        bi.setExtraStackFrame(r);
      } else
        bi.setExtraStackFrame(null);
    }
    __name(Sa, "Sa");
    function xa(e, t, r, a, f) {
      {
    ...
    function ss(e, t, r, a) {
      {
        if (typeof e.getChildContext != "function") {
          {
            var f = kt(t) || "Unknown";
            ka[f] || (ka[f] = true, l("%s.childContextTypes is specified but there is no getChildContext() method on the instance. You can either define getChildContext() on %s or remove childContextTypes from it.", f, f));
          }
          return r;
        }
    ...
    function Mo(e, t) {
      ...
      if (r === null)
        throw new Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");
      e.depth === r.depth ? Ea(e, r) : Mo(e, r), Bn(t);
    }
    __name(Mo, "Mo");
    function jo(e) {
      var t = Pn, r = e;
      t !== r && (t === null ? Ra(r) : r === null ? In(t) : t.depth === r.depth ? Ea(t, r) : t.depth > r.depth ? Ta(t, r) : Mo(t, r), Pn = r);
    }
    __name(jo, "jo");
    function ls(e, t) {
      var r;
    ...
    function us(e) {
      ...
      {
        var r = t.parentValue;
        r === ya ? t.context._currentValue2 = t.context._defaultValue : t.context._currentValue2 = r, e._currentRenderer2 !== void 0 && e._currentRenderer2 !== null && e._currentRenderer2 !== Un && l("Detected multiple renderers concurrently rendering the same context provider. This is currently unsupported."), e._currentRenderer2 = Un;
      }
      return Pn = t.parent;
    }
    __name(us, "us");
    ...
    __name(pl, "pl");
    var fs = {}, so = {}, Lo, xi, _a, Pa, Ia, lo, Uo, Bo, Aa;
    {
      Lo = /* @__PURE__ */ new Set(), xi = /* @__PURE__ */ new Set(), _a = /* @__PURE__ */ new Set(), Uo = /* @__PURE__ */ new Set(), Pa = /* @__PURE__ */ new Set(), Bo = /* @__PURE__ */ new Set(), Aa = /* @__PURE__ */ new Set();
      ...
      }, "lo"), Ia = /* @__PURE__ */ __name(function(e, t) {
        if (t === void 0) {
          var r = kt(e) || "Component";
          Pa.has(r) || (Pa.add(r), l("%s.getDerivedStateFromProps(): A valid state object (or null) must be returned. You have returned undefined.", r));
        }
      }, "Ia");
    }
    function Oa(e, t) {
...
Please check the code for the %s component.`, t, t, a), fs[f] = true;
    ...
    var Fa = {
      ...
      enqueueSetState: /* @__PURE__ */ __name(function(e, t, r) {
        var a = Si(e);
        a.queue === null ? Oa(e, "setState") : (a.queue.push(t), r != null && lo(r, "setState"));
      }, "enqueueSetState"),
      ...
      enqueueForceUpdate: /* @__PURE__ */ __name(function(e, t) {
        var r = Si(e);
        r.queue === null ? Oa(e, "forceUpdate") : t != null && lo(t, "setState");
      }, "enqueueForceUpdate")
    };
    function ki(e, t, r, a, f) {
      var v = r(f, a);
      Ia(t, v);
      ...
      var R = new e(t, a);
      {
        ...
        if (typeof e.getDerivedStateFromProps == "function" || typeof R.getSnapshotBeforeUpdate == "function") {
          ...
          if (typeof R.componentWillMount == "function" && R.componentWillMount.__suppressDeprecationWarning !== true ? Y = "componentWillMount" : typeof R.UNSAFE_componentWillMount == "function" && (Y = "UNSAFE_componentWillMount"), typeof R.componentWillReceiveProps == "function" && R.componentWillReceiveProps.__suppressDeprecationWarning !== true ? Z = "componentWillReceiveProps" : typeof R.UNSAFE_componentWillReceiveProps == "function" && (Z = "UNSAFE_componentWillReceiveProps"), typeof R.componentWillUpdate == "function" && R.componentWillUpdate.__suppressDeprecationWarning !== true ? ne = "componentWillUpdate" : typeof R.UNSAFE_componentWillUpdate == "function" && (ne = "UNSAFE_componentWillUpdate"), Y !== null || Z !== null || ne !== null) {
            ...
            _a.has(Fe) || (_a.add(Fe), l(`Unsafe legacy lifecycles will not be called for components using new component APIs.
    ...
    function ps(e, t, r) {
      {
        ...
        var v = e.props !== r;
        e.props !== void 0 && v && l("%s(...): When calling super() in `%s`, make sure to pass up the same props that your component's constructor was passed.", a, a), e.defaultProps && l("Setting defaultProps as an instance property on %s is not supported and will be ignored. Instead, define defaultProps as a static property on %s.", a, a), typeof e.getSnapshotBeforeUpdate == "function" && typeof e.componentDidUpdate != "function" && !xi.has(t) && (xi.add(t), l("%s: getSnapshotBeforeUpdate() should be used with componentDidUpdate(). This component defines getSnapshotBeforeUpdate() only.", kt(t))), typeof e.getDerivedStateFromProps == "function" && l("%s: getDerivedStateFromProps() is defined as an instance method and will be ignored. Instead, declare it as a static method.", a), typeof e.getDerivedStateFromError == "function" && l("%s: getDerivedStateFromError() is defined as an instance method and will be ignored. Instead, declare it as a static method.", a), typeof t.getSnapshotBeforeUpdate == "function" && l("%s: getSnapshotBeforeUpdate() is defined as a static method and will be ignored. Instead, declare it as an instance method.", a);
        var b = e.state;
...
Please update the following components: %s`,
      ...
      typeof t.UNSAFE_componentWillMount == "function" && t.UNSAFE_componentWillMount(), r !== t.state && (l("%s.componentWillMount(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.", kt(e) || "Component"), Fa.enqueueReplaceState(t, t.state, null));
    }
    __name(hs, "hs");
    function hl(e, t, r, a) {
    ...
    function vs(e, t, r, a) {
      ...
      e.updater = Fa, e.props = r, e.state = f;
      var v = {
        queue: [],
        replace: false
      };
      ...
      typeof F == "function" && (e.state = ki(e, t, F, f, r)), typeof t.getDerivedStateFromProps != "function" && typeof e.getSnapshotBeforeUpdate != "function" && (typeof e.UNSAFE_componentWillMount == "function" || typeof e.componentWillMount == "function") && (hs(t, e), hl(v, e, r, a));
    }
    __name(vs, "vs");
    var vl = {
      id: 1,
    ...
    __name(gl, "gl");
    var yl = Math.clz32 ? Math.clz32 : bl, Ei = Math.log, Da = Math.LN2;
    function bl(e) {
      var t = e >>> 0;
      return t === 0 ? 32 : 31 - (Ei(t) / Da | 0) | 0;
    }
    __name(bl, "bl");
    function wl(e, t) {
    ...
    __name(wl, "wl");
    var Sl = typeof Object.is == "function" ? Object.is : wl, wn = null, Ri = null, Ma = null, yt = null, Mr = false, uo = false, Nn = 0, et = null, On = 0, ja = 25, jr = false, Lr;
    function cn() {
      if (wn === null)
...
Incoming: %s`, Lr, "[" + e.join(", ") + "]", "[" + t.join(", ") + "]");
    ...
    __name(on, "on");
    function Fn() {
      return yt === null ? Ma === null ? (Mr = false, Ma = yt = on()) : (Mr = true, yt = Ma) : yt.next === null ? (Mr = false, yt = yt.next = on()) : (Mr = true, yt = yt.next), yt;
    }
    __name(Fn, "Fn");
    function zn(e, t) {
      wn = t, Ri = e, jr = false, Nn = 0;
    }
    __name(zn, "zn");
    function kl(e, t, r, a) {
      for (; uo; )
    ...
    __name(Ti, "Ti");
    function Ho() {
      jr = false, wn = null, Ri = null, uo = false, Ma = null, On = 0, et = null, yt = null;
    }
    __name(Ho, "Ho");
    function Cl(e) {
    ...
    __name(_i, "_i");
    function ms(e, t, r) {
      if (e !== La && (Lr = "useReducer"), wn = cn(), yt = Fn(), Mr) {
        ...
        jr = true;
        var Y;
        e === La ? Y = typeof t == "function" ? t() : t : Y = r !== void 0 ? r(t) : t, jr = false, yt.memoizedState = Y;
        var Z = yt.queue = {
          last: null,
          dispatch: null
    ...
    __name(Al, "Al");
    function Ol() {
      var e = Ri, t = ml(e.treeContext), r = Ii;
      if (r === null)
...
` + a.stack;
    ...
    __name(Ba, "Ba");
    var Na = c.ReactCurrentDispatcher, $o = c.ReactDebugCurrentFrame, za = 0, co = 1, Ha = 2, $a = 3, Wa = 4, fo = 0, Ai = 1, Hn = 2, xs = 12800;
    function Fl(e) {
    ...
    function ho(e, t, r, a, f, v, b, R, F) {
      ...
      var tt = $n(ne, e, null, Fe, Z, Fo, Ca, vl);
      return Y.push(tt), ne;
    }
    __name(ho, "ho");
    function Dl(e, t) {
    ...
    var Sn = null;
    function Oi() {
      return Sn === null || Sn.componentStack === null ? "" : Ba(Sn.componentStack);
    }
    __name(Oi, "Oi");
    function Wn(e, t) {
      e.componentStack = {
    ...
    function an(e, t) {
      ...
      a(t), e.destination !== null ? (e.status = Hn, G(e.destination, t)) : (e.status = Ai, e.fatalError = t);
    }
    __name(an, "an");
    function Yo(e, t, r) {
      Wn(t, "Suspense");
      var a = t.blockedBoundary, f = t.blockedSegment, v = r.fallback, b = r.children, R = /* @__PURE__ */ new Set(), F = Ml(e, R), Y = f.chunks.length, Z = Va(
        e,
        Y,
        F,
        f.formatContext,
      ...
      try {
        ...
        ne.status = Wa, F.forceClientRender = true, F.errorDigest = Vo(e, tt), Ya(F, tt);
      } finally {
    ...
    function ks(e, t, r, a, f) {
      var v = r.render();
      r.props !== f && (Mi || l("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", kt(a) || "a component"), Mi = true);
      {
    ...
    __name(jl, "jl");
    var Cs = {}, Jo = {}, Di = {}, Es = {}, Mi = false, Zo = {}, ji = false, Li = false, Ui = false;
    function Rs(e, t, r, a) {
      var f;
    ...
    function Ts(e) {
      {
        ...
        if (typeof e.contextType == "object" && e.contextType !== null) {
          var a = kt(e) || "Unknown";
          Di[a] || (l("%s: Function components do not support contextType.", a), Di[a] = true);
        }
      }
    }
    __name(Ts, "Ts");
    ...
    function _s(e, t, r, a, f) {
      Wo(t, r.render);
      var v = Xo(e, t, r.render, a, f), b = Ti();
      if (b) {
        var R = t.treeContext, F = 1, Y = 0;
        t.treeContext = Ci(R, F, Y);
        try {
          Ur(e, t, v);
        } finally {
          t.treeContext = R;
    ...
    function Ll(e, t, r, a, f) {
      var v = r.type, b = Bi(v, a);
      Ni(e, t, v, b, f);
    }
    __name(Ll, "Ll");
    function Ul(e, t, r, a) {
      r._context === void 0 ? r !== r.Consumer && (Ui || (Ui = true, l("Rendering <Context> directly is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?"))) : r = r._context;
      var f = a.children;
    ...
    function Bl(e, t, r, a, f) {
      Wn(t, "Lazy");
      var v = r._payload, b = r._init, R = b(v), F = Bi(R, a);
      Ni(e, t, R, F, f), fn(t);
    }
    __name(Bl, "Bl");
    function Ni(e, t, r, a, f) {
    ...
    function Nl(e, t) {
      ...
      e[Symbol.toStringTag] === "Generator" && (ji || l("Using Generators as children is unsupported and will likely yield unexpected results because enumerating a generator mutates it. You may convert it to an array with `Array.from()` or the `[...spread]` operator before rendering. Keep in mind you might need to polyfill these features for older browsers."), ji = true), e.entries === t && (Li || l("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), Li = true);
    }
    __name(Nl, "Nl");
    function Ur(e, t, r) {
      try {
        ...
        throw typeof a == "object" && a !== null && typeof a.then == "function" || (kn = kn !== null ? kn : Oi()), a;
      }
    }
    __name(Ur, "Ur");
    function zl(e, t, r) {
    ...
    __name(Ga, "Ga");
    function Hl(e, t, r) {
      var a = t.blockedSegment, f = a.chunks.length, v = Va(
        e,
        f,
        null,
        a.formatContext,
    ...
    function $l(e, t, r, a) {
      var f = Vo(e, a);
      if (t === null ? an(e, a) : (t.pendingTasks--, t.forceClientRender || (t.forceClientRender = true, t.errorDigest = f, Ya(t, a), t.parentFlushed && e.clientRenderedBoundaries.push(t))), e.allPendingTasks--, e.allPendingTasks === 0) {
        var v = e.onAllReady;
        v();
      }
    }
      ...
      if (r.status === za) {
        ...
        try {
          ...
          if (Ho(), typeof v == "object" && v !== null && typeof v.then == "function") {
            ...
            t.abortSet.delete(t), r.status = Wa, $l(e, t.blockedBoundary, r, v);
        } finally {
          Sn = a;
        }
      }
    ...
    function zi(e) {
      if (e.status !== Hn) {
        var t = cs(), r = Na.current;
        Na.current = ws;
        var a;
        a = $o.getCurrentStack, $o.getCurrentStack = Oi;
        var f = Ii;
        Ss(e.responseState);
        try {
          ...
          v.splice(0, b), e.destination !== null && Ja(e, e.destination);
        } catch (F) {
          Vo(e, F), an(e, F);
        } finally {
          Ss(f), Na.current = r, $o.getCurrentStack = a, r === ws && jo(t);
        }
      }
    }
    __name(zi, "zi");
    ...
    __name(Vl, "Vl");
    function Hi(e, t, r) {
      return Ro(t, e.responseState, r.formatContext, r.id), Qo(e, t, r), fa(t, r.formatContext);
    }
    __name(Hi, "Hi");
    function Ko(e, t, r) {
    ...
    function Fs(e, t, r, a) {
      ...
      if (f === -1) {
        ...
        return Hi(e, t, a), K(t, e.responseState, f);
    }
    __name(Fs, "Fs");
    function Ja(e, t) {
      try {
    ...
    function Ms(e, t) {
      try {
        ...
        r.forEach(function(a) {
          return As(a, e, t);
        }), r.clear(), e.destination !== null && Ja(e, e.destination);
      } catch (a) {
        Vo(e, a), an(e, a);
      }
    }
    ...
    function js(e, t, r, a) {
      ...
      __name(Y, "Y");
      var Z = ho(e, rl(r, t ? t.identifierPrefix : void 0), nl(), 1 / 0, $i, void 0, Y);
...
` && n.push(Zr), a;
    ...
    __name(Kn, "Kn");
    var qn = B('<div hidden id="'), eo = B('">'), ia = B("</div>"), sa = B('<svg aria-hidden="true" style="display:none" id="'), to = B('">'), ro = B("</svg>"), la = B('<math aria-hidden="true" style="display:none" id="'), ua = B('">'), ca = B("</math>"), Ro = B('<table hidden id="'), fa = B('">'), u = B("</table>"), h = B('<table hidden><tbody id="'), y = B('">'), k = B("</tbody></table>"), L = B('<table hidden><tr id="'), D = B('">'), W = B("</tr></table>"), K = B('<table hidden><colgroup id="'), _e = B('">'), Be = B("</colgroup></table>");
    function Le(n, e, t, r) {
      switch (t.insertionMode) {
        case ut:
        case ct:
        ...
        case tr:
          return I(n, sa), I(n, e.segmentPrefix), I(n, H(r.toString(16))), $(n, to);
        case rr:
          return I(n, la), I(n, e.segmentPrefix), I(n, H(r.toString(16))), $(n, ua);
        case Wr:
          return I(n, Ro), I(n, e.segmentPrefix), I(n, H(r.toString(16))), $(n, fa);
        // TODO: For the rest of these, there will be extra wrapper nodes that never
        // get deleted from the document. We need to delete the table too as part
        // of the injected scripts. They are invisible though so it's not too terrible
        // and it's kind of an edge case to suspend in a table. Totally supported though.
    ...
    function ll(n, e, t, r, a, f) {
      if (I(n, e.startInlineScript), e.sentClientRenderFunction ? I(n, al) : (e.sentClientRenderFunction = true, I(n, ol)), t === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return I(n, t), I(n, il), (r || a || f) && (I(n, Rr), I(n, H(pa(r || "")))), (a || f) && (I(n, Rr), I(n, H(pa(a || "")))), f && (I(n, Rr), I(n, H(pa(f)))), $(n, sl);
    }
    __name(ll, "ll");
    var es = /[<\u2028\u2029]/g;
    function pa(n) {
    ...
    __name(pa, "pa");
    var Dr = Object.assign, ts = Symbol.for("react.element"), ha = Symbol.for("react.portal"), va = Symbol.for("react.fragment"), ma = Symbol.for("react.strict_mode"), ga = Symbol.for("react.profiler"), To = Symbol.for("react.provider"), _o = Symbol.for("react.context"), oo = Symbol.for("react.forward_ref"), si = Symbol.for("react.suspense"), li = Symbol.for("react.suspense_list"), ui = Symbol.for("react.memo"), ya = Symbol.for("react.lazy"), rs = Symbol.for("react.scope"), ul = Symbol.for("react.debug_trace_mode"), cl = Symbol.for("react.legacy_hidden"), fl = Symbol.for("react.default_value"), ci = Symbol.iterator, kt = "@@iterator";
    function Po(n) {
    ...
    function wt(n) {
      ...
      if (typeof n == "object")
        switch (n.$$typeof) {
          case _o:
            var e = n;
            return fi(e) + ".Consumer";
          case To:
            var t = n;
            return fi(t._context) + ".Provider";
          case oo:
    ...
    __name(wt, "wt");
    var ao = 0, di, pi, hi, vi, os, as, ba;
    function wa() {
    }
    __name(wa, "wa");
    wa.__reactDisabledLog = true;
    function Io() {
      {
        if (ao === 0) {
          di = console.log, pi = console.info, hi = console.warn, vi = console.error, os = console.group, as = console.groupCollapsed, ba = console.groupEnd;
          var n = {
            configurable: true,
            enumerable: true,
            value: wa,
    ...
    __name(mi, "mi");
    var io = c.ReactCurrentDispatcher, gi;
    function Ln(n, e, t) {
      {
        if (gi === void 0)
          try {
...
` + b[F].replace(" at new ", " at ");
        ...
        yi = false, io.current = f, mi(), Error.prepareStackTrace = a;
      }
    ...
    __name(xa, "xa");
    var ka = {}, Fo = c.ReactDebugCurrentFrame;
    function Do(n) {
      if (n) {
        var e = n._owner, t = xa(n.type, n._source, e ? e.type : null);
    ...
    function cs(n, e) {
      ...
      if (t === null)
        throw new Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");
      n.depth === t.depth ? Mo(n, t) : cs(n, t), Ta(e);
    }
    __name(cs, "cs");
    function An(n) {
      var e = In, t = n;
    ...
    __name(xi, "xi");
    var _a = {}, Pa = {}, Ia, lo, Uo, Bo, Aa, No, Oa, Fa, ki;
    {
      Ia = /* @__PURE__ */ new Set(), lo = /* @__PURE__ */ new Set(), Uo = /* @__PURE__ */ new Set(), Oa = /* @__PURE__ */ new Set(), Bo = /* @__PURE__ */ new Set(), Fa = /* @__PURE__ */ new Set(), ki = /* @__PURE__ */ new Set();
      ...
      }, "No"), Aa = /* @__PURE__ */ __name(function(n, e) {
        if (e === void 0) {
...
Please check the code for the %s component.`, e, e, r), _a[a] = true;
      }
    }
    __name(ps, "ps");
    var hs = {
    ...
    function vs(n, e, t) {
      ...
      var b = new n(e, r);
      {
        if (typeof n.getDerivedStateFromProps == "function" && (b.state === null || b.state === void 0)) {
          ...
          Ia.has(R) || (Ia.add(R), l("`%s` uses `getDerivedStateFromProps` but its initial state is %s. This is not recommended. Instead, define the initial state by assigning an object to `this.state` in the constructor of `%s`. This ensures that `getDerivedStateFromProps` arguments have a consistent shape.", R, b.state === null ? "null" : "undefined", R));
        }
...
Please update the following components: %s`,
    ...
    function zo(n, e, t, r) {
      ...
      if (typeof v == "object" && v !== null ? n.context = so(v) : n.context = r, n.state === t) {
        ...
        Oa.has(b) || (Oa.add(b), l("%s: It is not recommended to assign props directly to state because updates to props won't be reflected in state. In most cases, it is better to use props directly.", b));
      }
      var R = e.getDerivedStateFromProps;
      typeof R == "function" && (n.state = hl(n, e, R, a, t)), typeof e.getDerivedStateFromProps != "function" && typeof n.getSnapshotBeforeUpdate != "function" && (typeof n.UNSAFE_componentWillMount == "function" || typeof n.componentWillMount == "function") && (ml(e, n), Ci(f, n, t, r));
    }
    __name(zo, "zo");
    var gl = {
      id: 1,
    ...
    __name(yl, "yl");
    function Ei(n, e, t) {
      var r = n.id, a = n.overflow, f = Da(r) - 1, v = r & ~(1 << f), b = t + 1, R = Da(e) + f;
      if (R > 30) {
        var F = f - f % 5, Y = (1 << F) - 1, Z = (v & Y).toString(32), ne = v >> F, Fe = f - F, tt = Da(e) + Fe, Xt = b << Fe, Yn = Xt | ne, Gn = Z + a;
        return {
          id: 1 << tt | Yn,
          overflow: Gn
        };
    ...
    __name(bl, "bl");
    var wl = Math.clz32 ? Math.clz32 : Ri, Sl = Math.log, wn = Math.LN2;
    function Ri(n) {
      var e = n >>> 0;
    ...
    __name(Ma, "Ma");
    var yt = typeof Object.is == "function" ? Object.is : Ma, Mr = null, uo = null, Nn = null, et = null, On = false, ja = false, jr = 0, Lr = null, cn = 0, xl = 25, on = false, Fn;
    function zn() {
      if (Mr === null)
        throw new Error(`Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:
1. You might have mismatching versions of React and the renderer (such as React DOM)
...
Incoming: %s`, Fn, "[" + n.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    __name(Ti, "Ti");
    function Ho() {
      return et === null ? Nn === null ? (On = false, Nn = et = Ti()) : (On = true, et = Nn) : et.next === null ? (On = false, et = et.next = Ti()) : (On = true, et = et.next), et;
    }
    __name(Ho, "Ho");
    function Cl(n, e) {
    ...
    function El(n, e, t, r) {
      for (; ja; )
        ja = false, jr = 0, cn += 1, et = null, t = n(e, r);
      return _i(), t;
    }
    __name(El, "El");
    function La() {
    ...
    __name(La, "La");
    function _i() {
      on = false, Mr = null, uo = null, ja = false, Nn = null, cn = 0, Lr = null, et = null;
    }
    __name(_i, "_i");
    function ms(n) {
    ...
    __name(Rl, "Rl");
    function ys(n, e, t) {
      if (n !== Pi && (Fn = "useReducer"), Mr = zn(), et = Ho(), On) {
        ...
        on = true;
        var F;
        n === Pi ? F = typeof e == "function" ? e() : e : F = t !== void 0 ? t(e) : e, on = false, et.memoizedState = F;
        var Y = et.queue = {
          last: null,
          dispatch: null
...
` + r.stack;
    ...
    __name(co, "co");
    var Ha = c.ReactCurrentDispatcher, $a = c.ReactDebugCurrentFrame, Wa = 0, fo = 1, Ai = 2, Hn = 3, xs = 4, Fl = 0, po = 1, ho = 2, Dl = 12800;
    function Ml(n) {
    ...
    function Va(n, e, t, r, a, f, v, b, R) {
      ...
      var Fe = Wn(Z, n, null, ne, Y, Ca, Ea, gl);
      return F.push(Fe), Z;
    }
    __name(Va, "Va");
    function Sn(n, e) {
    ...
    function ks(n, e, t) {
      kn(e, "Suspense");
      var r = e.blockedBoundary, a = e.blockedSegment, f = t.fallback, v = t.children, b = /* @__PURE__ */ new Set(), R = Oi(n, b), F = a.chunks.length, Y = Wo(
        n,
        F,
        R,
        a.formatContext,
      ...
      try {
        ...
        Z.status = xs, R.forceClientRender = true, R.errorDigest = Go(n, Fe), Fi(R, Fe);
      } finally {
    ...
    __name(Jo, "Jo");
    function Di(n, e, t, r, a) {
      var f = t.render();
      t.props !== a && (Ui || l("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", wt(r) || "a component"), Ui = true);
      {
        var v = r.childContextTypes;
        if (v != null) {
          var b = e.legacyContext, R = wi(t, r, b, v);
    ...
    function Es(n, e, t, r) {
      ...
      zo(f, t, r, a), Di(n, e, f, t, r), an(e);
    }
    __name(Es, "Es");
    var Mi = {}, Zo = {}, ji = {}, Li = {}, Ui = false, Rs = {}, Ts = false, Bi = false, _s = false;
    function Ll(n, e, t, r) {
      var a;
      if (a = Pn(t, e.legacyContext), Ya(e, t), t.prototype && typeof t.prototype.render == "function") {
        var f = wt(t) || "Unknown";
        Mi[f] || (l("The <%s /> component appears to have a render method, but doesn't extend React.Component. This is likely to cause errors. Change %s to extend React.Component instead.", f, f), Mi[f] = true);
      }
      var v = Jo(n, e, t, r, a), b = La();
      ...
      if (
        ...
        zo(v, t, r, a), Di(n, e, v, t, r);
      } else if (Ul(t), b) {
        var Y = e.treeContext, Z = 1, ne = 0;
        e.treeContext = Ei(Y, Z, ne);
        try {
          hr(n, e, v);
        } finally {
          e.treeContext = Y;
    ...
    function Ul(n) {
      {
        ...
        if (typeof n.getDerivedStateFromProps == "function") {
          var t = wt(n) || "Unknown";
          Li[t] || (l("%s: Function components do not support getDerivedStateFromProps.", t), Li[t] = true);
        }
        if (typeof n.contextType == "object" && n.contextType !== null) {
          var r = wt(n) || "Unknown";
          ji[r] || (l("%s: Function components do not support contextType.", r), ji[r] = true);
        }
      }
    }
    __name(Ul, "Ul");
    ...
    function Bl(n, e, t, r, a) {
      Ya(e, t.render);
      var f = Jo(n, e, t.render, r, a), v = La();
      if (v) {
        var b = e.treeContext, R = 1, F = 0;
        e.treeContext = Ei(b, R, F);
        try {
          hr(n, e, f);
        } finally {
          e.treeContext = b;
    ...
    function Ur(n, e, t, r) {
      ...
      b = e.context, e.context = Si(a, f), hr(n, e, v), e.context = pl(a), b !== e.context && l("Popping the context provider did not return back to the original snapshot. This is a bug in React.");
    }
    __name(Ur, "Ur");
    ...
    function Hl(n, e) {
      typeof Symbol == "function" && // $FlowFixMe Flow doesn't know about toStringTag
      n[Symbol.toStringTag] === "Generator" && (Ts || l("Using Generators as children is unsupported and will likely yield unexpected results because enumerating a generator mutates it. You may convert it to an array with `Array.from()` or the `[...spread]` operator before rendering. Keep in mind you might need to polyfill these features for older browsers."), Ts = true), n.entries === e && (Bi || l("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), Bi = true);
    }
    __name(Hl, "Hl");
    function hr(n, e, t) {
      try {
    ...
    function vo(n, e, t) {
      ...
      try {
        ...
        if (_i(), typeof b == "object" && b !== null && typeof b.then == "function") {
    ...
    function Os(n, e, t, r) {
      var a = Go(n, r);
      if (e === null ? Xo(n, r) : (e.pendingTasks--, e.forceClientRender || (e.forceClientRender = true, e.errorDigest = a, Fi(e, r), e.parentFlushed && n.clientRenderedBoundaries.push(e))), n.allPendingTasks--, n.allPendingTasks === 0) {
        var f = n.onAllReady;
        f();
      }
    }
    ...
    function Vl(n, e) {
      ...
      if (t.status === Wa) {
        ...
        try {
          ...
          if (_i(), typeof f == "object" && f !== null && typeof f.then == "function") {
            var a = e.ping;
            f.then(a, a);
          } else
    ...
    function Hi(n) {
      if (n.status !== ho) {
        var e = fs(), t = Ha.current;
        Ha.current = Na;
        var r;
        r = $a.getCurrentStack, $a.getCurrentStack = fn;
        var a = $o;
        za(n.responseState);
        try {
          ...
          f.splice(0, v), n.destination !== null && $i(n, n.destination);
        } catch (R) {
          Go(n, R), Xo(n, R);
        } finally {
          za(a), Ha.current = t, $a.getCurrentStack = r, t === Na && An(e);
        }
      }
    }
    __name(Hi, "Hi");
    ...
    function Xa(n, e, t) {
      ...
      if (r.pendingTasks > 0) {
        ...
        if (f.length !== 1)
          throw new Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");
        var v = f[0];
        return Xa(n, e, v), Mn(e, n.responseState);
      }
    }
    __name(Xa, "Xa");
    function Fs(n, e, t) {
    ...
    __name(Fs, "Fs");
    function Ja(n, e, t) {
      return Le(e, n.responseState, t.formatContext, t.id), Xa(n, e, t), ht(e, t.formatContext);
    }
    __name(Ja, "Ja");
    function Ds(n, e, t) {
    ...
    function Ms(n, e, t, r) {
      ...
      if (a === -1) {
        ...
        return Ja(n, e, r), tl(e, n.responseState, a);
    }
    __name(Ms, "Ms");
    function $i(n, e) {
      M();
      try {
        ...
        t !== null && n.pendingRootTasks === 0 && (Xa(n, e, t), n.completedRootSegment = null, _(e, n.responseState));
    ...
    function Ls(n, e) {
      try {
        ...
        t.forEach(function(r) {
          return zi(r, n, e);
        }), t.clear(), n.destination !== null && $i(n, n.destination);
      } catch (r) {
        Go(n, r), Xo(n, r);
      }
    }
    ...
    function Xl(n, e) {
      return new Promise(function(t, r) {
        ...
        __name(R, "R");
        var F = Va(n, er(e ? e.identifierPrefix : void 0, e ? e.nonce : void 0, e ? e.bootstrapScriptContent : void 0, e ? e.bootstrapScripts : void 0, e ? e.bootstrapModules : void 0), Ir(e ? e.namespaceURI : void 0), e ? e.progressiveChunkSize : void 0, e ? e.onError : void 0, f, b, R, a);
        if (e && e.signal) {
...
var ri = /* @__PURE__ */ __name((o = {}) => ({
  google: {
    clientId: o.GOOGLE_CLIENT_ID || void 0 || "",
    clientSecret: o.GOOGLE_CLIENT_SECRET || void 0 || "",
    redirectURI: o.GOOGLE_REDIRECT_URI || void 0
  },
  session: {
    maxAge: 3600 * 24 * 7,
    // 7 days in seconds
...
async function $f(o, i) {
  const c = i || ri(), d = await fetch("https://oauth2.googleapis.com/token", {
    method: "POST",
    headers: {
...
var Qa = /* @__PURE__ */ __name((o) => hd.test(o), "Qa");
...
var Gi = /* @__PURE__ */ __name((o) => ai(o, vc), "Gi");
...
var Od = /* @__PURE__ */ __name(() => {
  const o = Jt("color"), i = Jt("font"), c = Jt("text"), d = Jt("font-weight"), l = Jt("tracking"), S = Jt("leading"), E = Jt("breakpoint"), P = Jt("container"), g = Jt("spacing"), x = Jt("radius"), M = Jt("shadow"), I = Jt("inset-shadow"), $ = Jt("text-shadow"), te = Jt("drop-shadow"), G = Jt("blur"), se = Jt("perspective"), H = Jt("aspect"), B = Jt("ease"), he = Jt("animate"), ye = /* @__PURE__ */ __name(() => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], "ye"), Pe = /* @__PURE__ */ __name(() => [
    ...
    // Deprecated since Tailwind CSS v4.1.0, see https://github.com/tailwindlabs/tailwindcss/pull/17378
    "left-bottom"
  ], "Pe"), pe = /* @__PURE__ */ __name(() => [...Pe(), ge, me], "pe"), Ce = /* @__PURE__ */ __name(() => ["auto", "hidden", "clip", "visible", "scroll"], "Ce"), le = /* @__PURE__ */ __name(() => ["auto", "contain", "none"], "le"), ue = /* @__PURE__ */ __name(() => [ge, me, g], "ue"), xe = /* @__PURE__ */ __name(() => [Qa, "full", "auto", ...ue()], "xe"), Ge = /* @__PURE__ */ __name(() => [yo, "none", "subgrid", ge, me], "Ge"), ft = /* @__PURE__ */ __name(() => ["auto", {
    span: ["full", yo, ge, me]
  }, yo, ge, me], "ft"), Je = /* @__PURE__ */ __name(() => [yo, "auto", ge, me], "Je"), Ze = /* @__PURE__ */ __name(() => ["auto", "min", "max", "fr", ge, me], "Ze"), $e = /* @__PURE__ */ __name(() => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], "$e"), We = /* @__PURE__ */ __name(() => ["start", "end", "center", "stretch", "center-safe", "end-safe"], "We"), rt = /* @__PURE__ */ __name(() => ["auto", ...ue()], "rt"), ce = /* @__PURE__ */ __name(() => [Qa, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...ue()], "ce"), oe = /* @__PURE__ */ __name(() => [o, ge, me], "oe"), nt = /* @__PURE__ */ __name(() => [...Pe(), Lu, ju, {
    position: [ge, me]
  }], "nt"), St = /* @__PURE__ */ __name(() => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], "St"), A = /* @__PURE__ */ __name(() => ["auto", "cover", "contain", _d, Ed, {
    size: [ge, me]
  }], "A"), V = /* @__PURE__ */ __name(() => [ql, Gi, ta], "V"), ae = /* @__PURE__ */ __name(() => [
    ...
    ge,
    me
  ], "De"), Ee = /* @__PURE__ */ __name(() => ["none", He, ge, me], "Ee"), ze = /* @__PURE__ */ __name(() => ["none", He, ge, me], "ze"), bt = /* @__PURE__ */ __name(() => [He, ge, me], "bt"), Ut = /* @__PURE__ */ __name(() => [Qa, "full", ...ue()], "Ut");
  return {
    cacheSize: 500,
    theme: {
    ...
    classGroups: {
       ...
       */
      flex: [{
        flex: [He, Qa, "auto", "initial", "none", me]
      }],
      /**
       * Flex Grow
...
var aa = /* @__PURE__ */ __name((o, i, c, d) => {
...
var jd = aa("outline", "check", "Check", Md);
...
var Ud = aa("outline", "edit", "Edit", Ld);
...
var Nd = aa("outline", "logout", "Logout", Bd);
var zd = [["path", { d: "M12 5l0 14", key: "svg-0" }], ["path", { d: "M5 12l14 0", key: "svg-1" }]];
var Uu = aa("outline", "plus", "Plus", zd);
...
var Gd = aa("filled", "brand-google-filled", "BrandGoogleFilled", Yd);
  ...
  return /* @__PURE__ */ J.jsxs("div", { className: "min-h-screen bg-base-200", children: [
    /* @__PURE__ */ J.jsx(
      ti,
      {
        ...
        shadow: "md",
        position: "sticky",
        start: /* @__PURE__ */ J.jsx(ti.Brand, { children: "Store CRUD" }),
...
var Jp = {
  "src/client.tsx": { file: "static/client.js", css: ["assets/client-BlTxFEKx.css"] }
};
var Qi = new rc();
Qi.use(
...
Qi.get("/", (o) => {
  const i = ri(o.env), c = fu(o, i.session.cookieName);
  if (c)
    try {
  ...
  const l = {
    googleAuthUrl: `https://accounts.google.com/o/oauth2/v2/auth?${new URLSearchParams({
      client_id: i.google.clientId || "",
      redirect_uri: i.google.redirectURI,
      response_type: "code",
  ...
  return o.render(/* @__PURE__ */ J.jsx(Ep, { ...l }), { initialProps: l });
});
Qi.get("/dashboard", (o) => {
  const i = ri(o.env), c = fu(o, i.session.cookieName);
  if (!c)
...
vu.get("/callback/google", async (o) => {
  try {
    ...
    const c = ri(o.env), d = await $f(i, c), l = await Wf(d.access_token), S = {
      id: l.id,
      name: l.name,
      email: l.email,
      image: l.picture
...
// .wrangler/tmp/bundle-Joe82c/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = Qi;
...
// .wrangler/tmp/bundle-Joe82c/middleware-loader.entry.ts
