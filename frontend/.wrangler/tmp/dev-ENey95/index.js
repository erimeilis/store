...
// .wrangler/tmp/bundle-U5k9kB/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-U5k9kB/middleware-insertion-facade.js
init_modules_watch_stub();
...
var LayoutContextProvider = (0, import_react2.createContext)(null);
function LayoutProvider({
  ...
  const layoutStack = (0, import_react2.useMemo)(() => {
    return layoutSystem2.getLayoutsForRoute(currentRoute);
  }, [layoutSystem2, currentRoute]);
  const registerLayout = (0, import_react2.useCallback)((config) => {
    layoutSystem2.register(config);
  }, [layoutSystem2]);
  const unregisterLayout = (0, import_react2.useCallback)((path) => {
...
__name(LayoutProvider, "LayoutProvider");
...
function LayoutRenderer({
  ...
  const asyncParams = (0, import_react3.useMemo)(() => Promise.resolve(params), [params]);
  const asyncSearchParams = (0, import_react3.useMemo)(() => Promise.resolve(searchParams), [searchParams]);
  const renderLayoutHierarchy = (0, import_react3.useMemo)(() => {
...
__name(LayoutRenderer, "LayoutRenderer");
...
// node_modules/@headlessui/react/dist/hooks/use-disposables.js
function p() {
  let [e] = (0, import_react5.useState)(o2);
  return (0, import_react5.useEffect)(() => () => e.dispose(), [e]), e;
}
__name(p, "p");
...
var n = /* @__PURE__ */ __name((e, t5) => {
  s.isServer ? (0, import_react6.useEffect)(e, t5) : (0, import_react6.useLayoutEffect)(e, t5);
}, "n");

// node_modules/@headlessui/react/dist/hooks/use-latest-value.js
function s3(e) {
  let r6 = (0, import_react7.useRef)(e);
  return n(() => {
    r6.current = e;
  }, [e]), r6;
}
...
var o4 = /* @__PURE__ */ __name(function(t5) {
  let e = s3(t5);
  return import_react8.default.useCallback((...r6) => e.current(...r6), [e]);
}, "o");
...
function L() {
  let n3 = U();
  return (0, import_react9.useCallback)((r6) => C({ mergeRefs: n3, ...r6 }), [n3]);
}
__name(L, "L");
...
function F(n3, r6 = {}, e, a2, s5) {
  ...
  if (t5 === import_react9.Fragment && (Object.keys(m(o5)).length > 0 || Object.keys(m(u4)).length > 0)) if (!(0, import_react9.isValidElement)(f3) || Array.isArray(f3) && f3.length > 1) {
...
`));
    ...
    return (0, import_react9.cloneElement)(f3, Object.assign({}, g, u4, y2, { ref: s5(H(f3), y2.ref) }, T2));
  }
  return (0, import_react9.createElement)(t5, Object.assign({}, h(o5, ["ref"]), t5 !== import_react9.Fragment && y2, t5 !== import_react9.Fragment && u4), f3);
}
__name(F, "F");
function U() {
  let n3 = (0, import_react9.useRef)([]), r6 = (0, import_react9.useCallback)((e) => {
...
function K(n3) {
  var r6;
  return Object.assign((0, import_react9.forwardRef)(n3), { displayName: (r6 = n3.displayName) != null ? r6 : n3.name });
}
__name(K, "K");
function m(n3) {
...
__name(h, "h");
function H(n3) {
  return import_react9.default.version.split(".")[0] >= "19" ? n3.props.ref : n3.ref;
}
__name(H, "H");
...
var u2 = Symbol();
function y(...t5) {
  let n3 = (0, import_react10.useRef)(t5);
...
function c2(u4 = 0) {
  let [t5, l4] = (0, import_react11.useState)(u4), g = (0, import_react11.useCallback)((e) => l4(e), [t5]), s5 = (0, import_react11.useCallback)((e) => l4((a2) => a2 | e), [t5]), m2 = (0, import_react11.useCallback)((e) => (t5 & e) === e, [t5]), n3 = (0, import_react11.useCallback)((e) => l4((a2) => a2 & ~e), [l4]), F2 = (0, import_react11.useCallback)((e) => l4((a2) => a2 ^ e), [l4]);
...
function x2(t5, n3, e, i4) {
  let [r6, o5] = (0, import_react12.useState)(e), { hasFlag: s5, addFlag: a2, removeFlag: l4 } = c2(t5 && r6 ? 3 : 0), u4 = (0, import_react12.useRef)(false), f3 = (0, import_react12.useRef)(false), E2 = p();
  return n(() => {
    var d3;
    if (t5) {
      if (e && o5(true), !n3) {
...
var n2 = (0, import_react13.createContext)(null);
...
function u3() {
  return (0, import_react13.useContext)(n2);
}
__name(u3, "u");
function c4({ value: o5, children: t5 }) {
  return import_react13.default.createElement(n2.Provider, { value: o5 }, t5);
}
__name(c4, "c");
...
function f2() {
  let e = (0, import_react14.useRef)(false);
...
function ue(e) {
  var t5;
  return !!(e.enter || e.enterFrom || e.enterTo || e.leave || e.leaveFrom || e.leaveTo) || ((t5 = e.as) != null ? t5 : de) !== import_react15.Fragment || import_react15.default.Children.count(e.children) === 1;
}
__name(ue, "ue");
var w2 = (0, import_react15.createContext)(null);
w2.displayName = "TransitionContext";
var _e = ((n3) => (n3.Visible = "visible", n3.Hidden = "hidden", n3))(_e || {});
function De() {
  let e = (0, import_react15.useContext)(w2);
  if (e === null) throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return e;
}
__name(De, "De");
function He() {
  let e = (0, import_react15.useContext)(M2);
  if (e === null) throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return e;
}
__name(He, "He");
var M2 = (0, import_react15.createContext)(null);
...
__name(U2, "U");
function Te(e, t5) {
  let n3 = s3(e), l4 = (0, import_react15.useRef)([]), S3 = f2(), R2 = p(), d3 = o4((o5, i4 = A.Hidden) => {
  ...
  }), C3 = (0, import_react15.useRef)([]), p2 = (0, import_react15.useRef)(Promise.resolve()), h2 = (0, import_react15.useRef)({ enter: [], leave: [] }), g = o4((o5, i4, a2) => {
  ...
  return (0, import_react15.useMemo)(() => ({ children: l4, register: y2, unregister: d3, onStart: g, onStop: v2, wait: p2, chains: h2 }), [y2, d3, l4, g, v2, h2, p2]);
}
__name(Te, "Te");
var de = import_react15.Fragment;
var fe = O.RenderStrategy;
function Ae(e, t5) {
  var ee, te;
  let { transition: n3 = true, beforeEnter: l4, afterEnter: S3, beforeLeave: R2, afterLeave: d3, enter: y2, enterFrom: C3, enterTo: p2, entered: h2, leave: g, leaveFrom: v2, leaveTo: o5, ...i4 } = e, [a2, s5] = (0, import_react15.useState)(null), r6 = (0, import_react15.useRef)(null), f3 = ue(e), j3 = y(...f3 ? [r6, t5, s5] : t5 === null ? [] : [t5]), H2 = (ee = i4.unmount) == null || ee ? A.Unmount : A.Hidden, { show: u4, appear: z, initial: K2 } = De(), [m2, G] = (0, import_react15.useState)(u4 ? "visible" : "hidden"), Q = He(), { register: A2, unregister: I } = Q;
  n(() => A2(r6), [A2, r6]), n(() => {
  ...
  let ce = K2 && !z, Y = z && u4 && K2, W = (0, import_react15.useRef)(false), L3 = Te(() => {
  ...
  let he = L();
  return import_react15.default.createElement(M2.Provider, { value: L3 }, import_react15.default.createElement(c4, { value: N }, he({ ourProps: Ce, theirProps: i4, defaultTag: de, features: fe, visible: m2 === "visible", name: "Transition.Child" })));
}
__name(Ae, "Ae");
function Ie(e, t5) {
  let { show: n3, appear: l4 = false, unmount: S3 = true, ...R2 } = e, d3 = (0, import_react15.useRef)(null), y2 = ue(e), C3 = y(...y2 ? [d3, t5] : t5 === null ? [] : [t5]);
  l3();
  let p2 = u3();
  ...
  let [h2, g] = (0, import_react15.useState)(n3 ? "visible" : "hidden"), v2 = Te(() => {
    n3 || g("hidden");
  }), [o5, i4] = (0, import_react15.useState)(true), a2 = (0, import_react15.useRef)([n3]);
  n(() => {
    o5 !== false && a2.current[a2.current.length - 1] !== n3 && (a2.current.push(n3), i4(false));
  }, [a2, n3]);
  let s5 = (0, import_react15.useMemo)(() => ({ show: n3, appear: l4, initial: o5 }), [n3, l4, o5]);
  n(() => {
  ...
  return import_react15.default.createElement(M2.Provider, { value: v2 }, import_react15.default.createElement(w2.Provider, { value: s5 }, H2({ ourProps: { ...r6, as: import_react15.Fragment, children: import_react15.default.createElement(me, { ref: C3, ...r6, ...R2, beforeEnter: f3, beforeLeave: j3 }) }, theirProps: {}, defaultTag: import_react15.Fragment, features: fe, visible: h2 === "visible", name: "Transition" })));
}
__name(Ie, "Ie");
function Le(e, t5) {
  let n3 = (0, import_react15.useContext)(w2) !== null, l4 = u3() !== null;
  return import_react15.default.createElement(import_react15.default.Fragment, null, !n3 && l4 ? import_react15.default.createElement(X, { ref: t5, ...e }) : import_react15.default.createElement(me, { ref: t5, ...e }));
}
__name(Le, "Le");
var X = K(Ie);
var me = K(Ae);
...
function Button({
  ...
  const renderContent = /* @__PURE__ */ __name(() => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    ...
    !processing && !success && !fail && icon && React6.createElement(icon, { size: isIconOnly ? 16 : 12, className: isIconOnly ? "" : "mr-2" }),
...
__name(DashboardLayout, "DashboardLayout");
...
var TableWrapper = React7.forwardRef(
...
var TableHeaderCell = React7.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
    "th",
    {
      ref,
...
function DateFilterCalendar({
  openDateFilters: _openDateFilters,
  calendarPositions: _calendarPositions,
  columnFilters: _columnFilters,
  onDateSelect: _onDateSelect
}) {
  return null;
}
__name(DateFilterCalendar, "DateFilterCalendar");
...
function ModelListModals({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
    deleteModalOpen && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "modal modal-open", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "modal-box", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h3", { className: "font-bold text-lg", children: "Confirm Delete" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("p", { className: "py-4", children: "Are you sure you want to delete this item? This action cannot be undone." }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "modal-action", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
          "button",
          {
            ...
            disabled: isDeleting,
            children: [
              isDeleting && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "loading loading-spinner loading-sm" }),
              "Delete"
            ]
          }
        )
    ...
    massActionModalOpen && selectedMassAction && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "modal modal-open", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "modal-box", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("h3", { className: "font-bold text-lg", children: [
        "Confirm ",
        selectedMassAction.label
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("p", { className: "py-4", children: selectedMassAction.confirmMessage || `Are you sure you want to ${selectedMassAction.label.toLowerCase()} ${selectedCount} item${selectedCount === 1 ? "" : "s"}?` }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "modal-action", children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "button",
          {
            className: "btn btn-outline",
            onClick: onCloseMassActionModal,
            disabled: isExecutingMassAction,
            children: "Cancel"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
          "button",
          {
            className: `btn ${selectedMassAction.name === "delete" ? "btn-error" : "btn-primary"}`,
            onClick: onConfirmMassAction,
            disabled: isExecutingMassAction,
            children: [
              isExecutingMassAction && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "loading loading-spinner loading-sm" }),
              selectedMassAction.label
            ]
          }
        )
...
__name(ModelListModals, "ModelListModals");
...
function DateEditComponent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "w-full flex items-center gap-2", children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      "input",
      {
        type: "date",
        className: `input input-sm input-ghost w-full ${editingError ? "input-error" : ""}`,
        value: editValue,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      "button",
      {
        className: `btn btn-sm btn-square ${editingSaveSuccess ? "btn-success" : "btn-primary"}`,
        ...
        disabled: isEditingSaving,
        title: "Save changes",
        children: isEditingSaving ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "loading loading-spinner loading-xs" }) : editingSaveSuccess ? "\u2713" : "\u{1F4BE}"
      }
    ),
    editingError && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "text-error text-xs mt-1", children: editingError })
  ] });
}
__name(DateEditComponent, "DateEditComponent");
...
function SelectEditComponent({
  ...
  const handleSelectChange = /* @__PURE__ */ __name(async (e) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "w-full", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
      "select",
      {
        className: `select select-sm select-ghost w-full ${editingError ? "select-error" : ""}`,
        value: editValue,
        ...
        children: [
          ...
          column.editOptions.map((option) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("option", { value: option.value, children: option.label }, option.value))
        ]
      }
    ),
    editingError && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "text-error text-xs mt-1", children: editingError })
  ] });
}
__name(SelectEditComponent, "SelectEditComponent");
...
function TextEditComponent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "w-full flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
      "button",
      {
        ...
        disabled: isEditingSaving,
        title: "Save changes",
        children: isEditingSaving ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "loading loading-spinner loading-xs" }) : editingSaveSuccess ? "\u2713" : "\u{1F4BE}"
      }
    ),
    editingError && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "text-error text-xs mt-1", children: editingError })
  ] });
}
__name(TextEditComponent, "TextEditComponent");
...
function ToggleEditComponent({
  ...
  const isChecked = editValue === "true" || editValue === "True" || editValue === "1";
  const handleToggleChange = /* @__PURE__ */ __name(async (e) => {
    const newValue = e.target.checked ? "true" : "false";
    onSetEditValue(newValue);
    await onSaveEditing(newValue);
  }, "handleToggleChange");
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "w-full", children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "form-control", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("label", { className: "label cursor-pointer justify-start gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
        "input",
        {
          type: "checkbox",
          className: `toggle toggle-sm ${editingError ? "toggle-error" : "toggle-primary"}`,
          checked: isChecked,
      ...
      isEditingSaving && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { className: "loading loading-spinner loading-xs" })
    ] }) }),
    editingError && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "text-error text-xs mt-1", children: editingError })
  ] });
}
__name(ToggleEditComponent, "ToggleEditComponent");
...
function InlineEditComponent(props) {
  ...
  if (column.editType === "select" && column.editOptions) {
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(SelectEditComponent, { ...props });
  }
  if (column.editType === "date") {
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(DateEditComponent, { ...props });
  }
  if (column.editType === "toggle") {
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(ToggleEditComponent, { ...props });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(TextEditComponent, { ...props });
}
__name(InlineEditComponent, "InlineEditComponent");
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { children: cellContent }),
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "ml-1 text-xs opacity-0 transition-opacity duration-150 group-hover:opacity-100", children: "\u270F\uFE0F" })
        ] })
      }
    );
  }
...
__name(TableCellContent, "TableCellContent");
function ModelTableRow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("tr", { className: "hover:bg-base-300", children: [
    /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("td", { className: "w-4 cursor-pointer", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "flex items-center", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
      "input",
      {
        type: "checkbox",
    ...
    useLegacyRendering ? renderItem && renderItem(item) : columns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("td", { className: `${column.className || ""}`, children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
      TableCellContent,
      {
        item,
        column,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("td", { className: "w-fit text-right", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "flex items-center justify-end gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("a", { href: editRoute(item.id), className: "btn btn-sm btn-primary btn-outline", children: "\u270F\uFE0F Edit" }),
...
__name(ModelTableRow, "ModelTableRow");
function ModelTableBody({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("tbody", { children: !items || !items.data || items.data.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("td", { colSpan: 100, className: "p-2 text-center", children: "No items found" }) }) : items.data.map((item) => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
    ModelTableRow,
    {
      item,
      columns,
...
__name(ModelTableBody, "ModelTableBody");
...
function DateFilterCell({
  ...
  calendarTriggersRef,
  onColumnFilter,
  onToggleDateFilter: _onToggleDateFilter
}) {
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "relative", children: [
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      "input",
      {
        ...
        value: filterValue,
        onChange: (e) => onColumnFilter(String(column.key), e.target.value, "date")
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      "div",
      {
        ref: (el) => {
          if (calendarTriggersRef.current) {
            calendarTriggersRef.current[String(column.key)] = el;
          }
        },
...
__name(DateFilterCell, "DateFilterCell");
...
function SelectFilterCell({
  ...
  if (!column.filterOptions) return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", {}, String(column.key));
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
    "select",
    {
      className: "select select-xs w-full",
      value: filterValue,
      onChange: (e) => onColumnFilter(String(column.key), e.target.value, "select"),
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("option", { value: "", children: [
          "All ",
          column.label
        ] }),
        column.filterOptions.map((option) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("option", { value: option.value, children: option.label }, option.value))
      ]
    }
  ) }, String(column.key));
}
__name(SelectFilterCell, "SelectFilterCell");
...
function TextFilterCell({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
    "input",
    {
      type: "text",
      className: "input input-xs w-full",
      ...
      value: filterValue,
      onChange: (e) => onColumnFilter(String(column.key), e.target.value, "text")
    }
  ) }, String(column.key));
}
__name(TextFilterCell, "TextFilterCell");
...
function FilterCell({
  ...
  if (!column.filterable) return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("td", {}, String(column.key));
  if (column.filterType === "select" && column.filterOptions) {
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(SelectFilterCell, { column, filterValue, onColumnFilter });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(TextFilterCell, { column, filterValue, onColumnFilter });
}
__name(FilterCell, "FilterCell");
function FiltersRow({
  columns,
  columnFilters,
  calendarTriggersRef,
...
function ColumnHeaderCell({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("th", { className: `${column.headerClassName || ""}`, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { className: "flex items-center space-x-2", children: column.sortable ? /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(
    "button",
    {
      onClick: () => onSort(String(column.key)),
      className: "flex items-center space-x-1 font-medium hover:text-primary",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { children: column.label }),
        isSorted && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { className: "text-sm", children: sortDirection === "asc" ? "\u2191" : "\u2193" })
      ]
    }
  ) : /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { className: "font-medium", children: column.label }) }) }, String(column.key));
}
__name(ColumnHeaderCell, "ColumnHeaderCell");
function TableHeader({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("thead", { className: "bg-base-200 text-xs uppercase", children: [
    /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("tr", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("th", { children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { className: "flex items-center", children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
        "input",
        {
          type: "checkbox",
          className: "checkbox checkbox-sm",
      ...
      useLegacyRendering ? renderHeader && renderHeader() : columns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(ColumnHeaderCell, { column, filters, onSort }, String(column.key))),
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("th", { className: "w-24 text-right", children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { className: "flex justify-end", children: "\u22EF" }) })
    ] }),
    showFilters && hasFilterableColumns && !useLegacyRendering && columnFilters && openDateFilters && calendarTriggersRef && onColumnFilter && onToggleDateFilter && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
      FiltersRow,
      {
        columns,
        columnFilters,
...
function ModelList({
  ...
  const [selectedItems, setSelectedItems] = (0, import_react18.useState)(/* @__PURE__ */ new Set());
  const [columnFilters, setColumnFilters] = (0, import_react18.useState)({});
  const [showFilters, setShowFilters] = (0, import_react18.useState)(false);
  const [openDateFilters, setOpenDateFilters] = (0, import_react18.useState)(/* @__PURE__ */ new Set());
  const [calendarPositions, setCalendarPositions] = (0, import_react18.useState)({});
  const calendarTriggersRef = (0, import_react18.useRef)({});
  const [deleteModalOpen, setDeleteModalOpen] = (0, import_react18.useState)(false);
  const [itemToDelete, setItemToDelete] = (0, import_react18.useState)(null);
  const [isDeleting, setIsDeleting] = (0, import_react18.useState)(false);
  const [massActionModalOpen, setMassActionModalOpen] = (0, import_react18.useState)(false);
  const [selectedMassAction, setSelectedMassAction] = (0, import_react18.useState)(null);
  const [isExecutingMassAction, setIsExecutingMassAction] = (0, import_react18.useState)(false);
  const [editingCell, setEditingCell] = (0, import_react18.useState)(null);
  const [editValue, setEditValue] = (0, import_react18.useState)("");
  const [isEditingSaving, setIsEditingSaving] = (0, import_react18.useState)(false);
  const [editingError, setEditingError] = (0, import_react18.useState)("");
  const [isClickingSaveButton, setIsClickingSaveButton] = (0, import_react18.useState)(false);
  const [editingSaveSuccess, setEditingSaveSuccess] = (0, import_react18.useState)(false);
  const debounceTimeouts = (0, import_react18.useRef)({});
  ...
  const handleSort = /* @__PURE__ */ __name((columnKey) => {
  ...
  const updateUrlWithFilter = (0, import_react18.useCallback)((columnKey, value) => {
    const params = new URLSearchParams(window.location.search);
    if (value.trim() === "") {
  ...
  const handleColumnFilter = /* @__PURE__ */ __name((columnKey, value, filterType) => {
  ...
  const clearAllFilters = /* @__PURE__ */ __name(() => {
    setColumnFilters({});
  ...
  const handleItemSelect = /* @__PURE__ */ __name((itemId, checked) => {
  ...
  const openDeleteModal = /* @__PURE__ */ __name((item) => {
    setItemToDelete(item);
    setDeleteModalOpen(true);
  }, "openDeleteModal");
  const closeDeleteModal = /* @__PURE__ */ __name(() => {
    setDeleteModalOpen(false);
    setItemToDelete(null);
    setIsDeleting(false);
  }, "closeDeleteModal");
  const handleDeleteConfirm = /* @__PURE__ */ __name(async () => {
  ...
  const startEditing = /* @__PURE__ */ __name((item, column) => {
  ...
  const cancelEditing = /* @__PURE__ */ __name(() => {
    setEditingCell(null);
    setEditValue("");
    setEditingError("");
  ...
  const handleSaveSuccess = /* @__PURE__ */ __name(() => {
    setIsEditingSaving(false);
  ...
  const handleInputBlur = /* @__PURE__ */ __name(() => {
    if (!isClickingSaveButton) {
      cancelEditing();
    }
  }, "handleInputBlur");
  const validateEditValue = /* @__PURE__ */ __name((column, value) => {
  ...
  const saveEditing = /* @__PURE__ */ __name(async (valueToSave) => {
  ...
  const handleEditKeyPress = /* @__PURE__ */ __name((e) => {
    if (e.key === "Enter") {
      e.preventDefault();
      saveEditing();
  ...
  const toggleDateFilter = /* @__PURE__ */ __name((columnKey) => {
  ...
  const handleDateSelect = /* @__PURE__ */ __name((columnKey, date) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "px-4 py-6", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "space-y-6", children: [
    /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("h1", { className: "text-2xl font-bold", children: title }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "card bg-base-100 shadow-xl", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "card-body", children: [
      /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "mb-4 flex items-baseline justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "font-semibold", children: [
          "All ",
          title
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "flex items-center space-x-4", children: selectedItems.size > 0 && /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "flex items-center space-x-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "text-base-content/70 font-light", children: [
            "(",
            selectedItems.size,
            " selected)"
          ] }),
          massActions && massActions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "flex items-center space-x-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("span", { className: "text-base-content/70 text-sm", children: "\u2022" }),
            /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "flex items-center space-x-1", children: massActions.map((action) => /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
              "button",
              {
                className: `btn btn-sm ${action.name === "delete" ? "btn-error" : "btn-primary"}`,
        ...
        hasFilterableColumns && /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "flex items-center space-x-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
            "button",
            {
              className: "btn btn-sm btn-outline",
              onClick: () => setShowFilters(!showFilters),
              children: "\u{1F50D} Filters"
            }
          ),
          Object.keys(columnFilters).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
            "button",
            {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("table", { className: "table table-zebra w-full", children: [
        /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
          TableHeader,
          {
            columns,
      ...
      items && items.last_page && items.last_page > 1 && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "flex justify-center mt-4", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "join", children: Array.from({ length: items.last_page }, (_, i4) => i4 + 1).map((page) => /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("button", { className: "join-item btn btn-sm", children: page }, page)) }) })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
      DateFilterCalendar,
      {
...
var userColumns = [
  ...
  },
  {
    ...
    filterable: true,
    filterType: "text",
    render: /* @__PURE__ */ __name((user) => user.name || "-", "render")
  },
  {
    key: "role",
    label: "Role",
    ...
    render: /* @__PURE__ */ __name((user) => /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: `badge ${user.role === "admin" ? "badge-primary" : "badge-secondary"}`, children: user.role === "admin" ? "Admin" : "User" }), "render")
  },
  {
    key: "picture",
    label: "Avatar",
    render: /* @__PURE__ */ __name((user) => user.picture ? /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "avatar", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "w-8 h-8 rounded-full", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("img", { src: user.picture, alt: `${user.name || user.email} avatar` }) }) }) : /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "avatar placeholder", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "bg-neutral text-neutral-content rounded-full w-8 h-8", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "text-xs", children: (user.name || user.email)?.[0]?.toUpperCase() }) }) }), "render")
  },
  {
    key: "created_at",
    label: "Created",
    ...
    filterable: true,
    filterType: "date",
    render: /* @__PURE__ */ __name((user) => new Date(user.created_at).toLocaleDateString(), "render")
  }
];
var userMassActions = [
  {
...
__name(UsersPage, "UsersPage");

// src/app/dashboard/users/create/page.tsx
init_modules_watch_stub();

// src/components/model/ModelEdit.tsx
init_modules_watch_stub();
...
function ModelEdit({
  ...
  const isNew = !item;
  const [data, setData] = (0, import_react19.useState)(item || {});
  ...
  const handleDataChange = /* @__PURE__ */ __name((key, value) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { className: "px-4 py-6", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "space-y-6", children: [
    /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("h1", { className: "text-2xl font-bold", children: headingTitle }),
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("a", { href: backRoute, className: "btn btn-outline", children: "\u2190 Back to List" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("form", { onSubmit: handleSubmit, children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { className: "card bg-base-100 shadow-xl", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "card-body", children: [
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("h2", { className: "card-title", children: isNew ? `New ${title}` : `${title} Details` }),
      errors.general && /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { className: "alert alert-error", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("span", { children: errors.general }) }),
      renderForm(data, handleDataChange, errors, processing, readonly),
      !readonly && /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "card-actions justify-between mt-6", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(
          "button",
          {
            ...
            disabled: processing,
            children: [
              processing && /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("span", { className: "loading loading-spinner loading-sm" }),
              isNew ? "Create" : "Update",
              " ",
              title
            ]
...
__name(ModelEdit, "ModelEdit");

// src/app/dashboard/users/create/page.tsx
var import_jsx_runtime26 = __toESM(require_jsx_runtime(), 1);
var renderUserForm = /* @__PURE__ */ __name((data, setData, errors, processing, readonly) => {
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { className: "space-y-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { className: "form-control w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text", children: "Email *" }) }),
      ...
      errors.email && /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text-alt text-error", children: errors.email }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { className: "form-control w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text", children: "Full Name" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
        "input",
        {
          type: "text",
      ...
      errors.name && /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text-alt text-error", children: errors.name }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { className: "form-control w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text", children: "Role *" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(
        "select",
        {
          ...
          required: true,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("option", { value: "user", children: "User" }),
            /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("option", { value: "admin", children: "Admin" })
          ]
        }
      ),
      errors.role && /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text-alt text-error", children: errors.role }) }),
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text-alt", children: "Users can manage their own data, admins can manage all system data." }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { className: "form-control w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text", children: "Profile Picture URL" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
        "input",
        {
          type: "url",
      ...
      errors.picture && /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text-alt text-error", children: errors.picture }) }),
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text-alt", children: "Profile pictures are typically managed through Google OAuth." }) })
    ] }),
    readonly && data.created_at && /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { className: "form-control w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { className: "label-text", children: "Created At" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
        "input",
        {
          type: "text",
...
__name(CreateUserPage, "CreateUserPage");

// src/app/dashboard/users/edit/[id]/page.tsx
init_modules_watch_stub();
var import_jsx_runtime27 = __toESM(require_jsx_runtime(), 1);
var renderUserForm2 = /* @__PURE__ */ __name((data, setData, errors, processing, readonly) => {
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "space-y-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "form-control w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text", children: "Email *" }) }),
      ...
      errors.email && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text-alt text-error", children: errors.email }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "form-control w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text", children: "Full Name" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
        "input",
        {
          type: "text",
      ...
      errors.name && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text-alt text-error", children: errors.name }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "form-control w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text", children: "Role *" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(
        "select",
        {
          ...
          required: true,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("option", { value: "user", children: "User" }),
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("option", { value: "admin", children: "Admin" })
          ]
        }
      ),
      errors.role && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text-alt text-error", children: errors.role }) }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text-alt", children: "Users can manage their own data, admins can manage all system data." }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "form-control w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text", children: "Profile Picture URL" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
        "input",
        {
          type: "url",
      ...
      errors.picture && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text-alt text-error", children: errors.picture }) }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text-alt", children: "Profile pictures are typically managed through Google OAuth." }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "divider", children: "System Information" }),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "form-control w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text", children: "User ID" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
        "input",
        {
          type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "form-control w-full", children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text", children: "Created At" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "form-control w-full", children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("label", { className: "label", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "label-text", children: "Updated At" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
          "input",
          {
            type: "text",
...
function EditUserPage({
  ...
  if (!user && params?.id) {
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "px-4 py-6", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "alert alert-warning", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("span", { children: [
  ...
  if (!user) {
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "px-4 py-6", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "alert alert-error", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { children: "User not found" }) }) });
  }
...
__name(EditUserPage, "EditUserPage");
...
var Card = React11.forwardRef(
  ({ className, size, style, modifier, shadow, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
    "div",
    {
      ref,
...
var CardActions = React11.forwardRef(
  ({ className, justify, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
    "div",
    {
      ref,
...
var CardFigure = React11.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
    "figure",
    {
      ref,
...
function LoginPage({ params: _params, searchParams: _searchParams, googleAuthUrl = "/auth/google" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "min-h-screen flex items-center justify-center bg-base-200", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "w-full max-w-md p-8", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(CardWithCompoundComponents, { shadow: "xl", size: "xl", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(CardWithCompoundComponents.Body, { className: "items-center text-center", children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(CardWithCompoundComponents.Title, { className: "text-3xl mb-2", children: "Store CRUD" }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { className: "text-base-content/70 mb-8", children: "A modern store management application built with Hono" }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(CardWithCompoundComponents.Actions, { className: "w-full flex justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
      Button,
      {
        color: "primary",
        style: "soft",
...
app.use(
  reactRenderer(({ children, initialProps }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(import_jsx_runtime30.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("html", { "data-theme": "dim", children: [
      /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("head", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("meta", { charSet: "utf-8" }),
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("meta", { name: "viewport", content: "width=device-width, initial-scale=1" }),
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("link", { rel: "icon", href: faviconDataUri, type: "image/svg+xml" }),
        cssFiles.map((cssFile) => /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("link", { rel: "stylesheet", href: `/${cssFile}` }, cssFile)),
        !isProduction && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("link", { rel: "stylesheet", href: "/styles.css" }),
        initialProps && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("script", { dangerouslySetInnerHTML: {
          __html: `window.__INITIAL_PROPS__ = ${JSON.stringify(initialProps)};`
        } })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("body", { className: "min-h-screen bg-base-200", "data-theme": "dim", children: [
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { id: "app", children }),
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("script", { type: "module", src: jsFile })
      ] })
    ] }) });
  })
);
...
app.get("/", (c6) => {
  ...
  const searchParams = Object.fromEntries(
    Object.entries(c6.req.queries()).map(([key, values]) => [key, values[0] || ""])
  );
  ...
  return c6.render(content, { initialProps: { googleAuthUrl } });
});
app.get("/dashboard", (c6) => {
  ...
  return c6.render(content, { initialProps: dashboardProps });
});
app.get("/dashboard/users", async (c6) => {
  const usersAuthConfig = createAuthConfig(c6.env);
  const sessionCookie = getCookie(c6, usersAuthConfig.session.cookieName);
  if (!sessionCookie) {
    return c6.redirect("/");
  }
  let user;
  ...
  let users = null;
  try {
    const apiUrl = c6.env?.API_URL || "http://localhost:8787";
    const token = c6.env?.FRONTEND_ACCESS_TOKEN;
    if (token) {
      const response = await fetch(`${apiUrl}/api/users?${new URLSearchParams(c6.req.queries()).toString()}`, {
        headers: {
  ...
  const usersProps = {
    ...
    users,
    filters: {
      sort: c6.req.query("sort"),
      direction: c6.req.query("direction")
    }
  };
  const content = /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
    LayoutProvider,
  ...
  return c6.render(content, { initialProps: usersProps });
});
app.get("/dashboard/users/create", (c6) => {
  const createAuthConfig2 = createAuthConfig2(c6.env);
  const sessionCookie = getCookie(c6, createAuthConfig2.session.cookieName);
  if (!sessionCookie) {
    return c6.redirect("/");
  }
  let user;
  ...
  return c6.render(content, { initialProps: createProps });
});
app.get("/dashboard/users/edit/:id", (c6) => {
  const editAuthConfig = createAuthConfig(c6.env);
  const sessionCookie = getCookie(c6, editAuthConfig.session.cookieName);
  if (!sessionCookie) {
    return c6.redirect("/");
  }
  let user;
  ...
  const params = { id: c6.req.param("id") };
  const searchParams = Object.fromEntries(
    Object.entries(c6.req.queries()).map(([key, values]) => [key, values[0] || ""])
  );
  const editProps = {
  ...
  return c6.render(content, { initialProps: editProps });
});
var auth = new Hono2();
auth.get("/token", (c6) => {
  return c6.json({
